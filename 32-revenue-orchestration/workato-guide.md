...
- `record_run_summary`: Capture deterministic summary, dedupe, and retry state for Revenue Orchestration (Approval-Gated). Inputs: run_context, delivery results. Outputs: execution summary. Native features: Variables, Data tables.
