# Pipeline & Forecast Digest — Platform-Agnostic Recipe
...
- Keep top-record selection and per-opportunity expansion deterministic.
- Aggregate the enriched opportunity payloads before the final summary pass.
- Send the digest through a native Slack delivery step.
