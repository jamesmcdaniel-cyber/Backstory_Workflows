...
- `workflows.json`: catalog data for the workflow library, including rollout metadata, platform status, and cross-tool productization patterns
- numbered workflow directories such as `01-*` through `38-*`: workflow assets and downloadable files used by the detail pages
